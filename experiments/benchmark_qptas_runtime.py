...
from compare_scalability_approaches import StreamingCsvWriter, simulate_random_payoffs  # noqa: E402
...
def main():
    ...
    metadata = vars(args) | {
        ...
        "source_sha256": {
            ...
            for name in ("src/cumg/qptas.py", "src/cumg/small_support.py", "experiments/benchmark_qptas_runtime.py")
        },
    }
